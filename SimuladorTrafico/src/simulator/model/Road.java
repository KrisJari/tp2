...
<<<<<<< HEAD
		...
		if (maxSpeed < 0)
		throw new IllegalArgumentException( "Max Speed canÂ´t be negative");
	if (contLimit < 0)
		throw new IllegalArgumentException( "The contamination limit canÂ´t be negative");
	if (length < 0)
		throw new IllegalArgumentException( "The leght canÂ´t be negative");
	if (srcJunct == null)
		throw new IllegalArgumentException( "The source road canÂ´t be null");
	if(destJunc == null)
		throw new IllegalArgumentException( "The destination road canÂ´t be null");
	if (weather == null)
		throw new IllegalArgumentException( "The weather canÂ´t be null");
...
>>>>>>> 9c6f8d2d4f0dedfd9c80edefae02a2f94690fff4
	}
